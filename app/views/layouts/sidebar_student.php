    ...
    <aside class="sidebar" id="sidebar">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="/bulletins/bulletin?student_id=<?php echo $_SESSION['user_id']; ?>" id="nav-bulletins"><i class="fa-solid fa-graduation-cap"></i> <span data-translate="student_bulletin"></span></a></a></li>
                    <br>
